...
1. Github Actions 用の Valgrind をインストールした Dockerfile を書いて，[dockerhub](https://hub.docker.com/r/solareenlo/42valgrind) か ghcr に置く．
    ...
    ```
1. 上記を実行する [Docker container action](https://github.com/solareenlo/42valgrind-action/blob/70a2e79c6cc27ad850a962827130d82e4635d00b/action.yml#L16) を書いて，[マーケットプレイスに公開する](https://github.com/marketplace/actions/42valgrind-leak-checker)．
    ```yml:action.yml
